...
function DeleteQuiz(props) {
  ...
  if(!props.quizDeleteMode){
    layout = <Button color="inherit" onClick = {handleClick}>Delete</Button>
  }
  else{
    layout =  <div><Button color="inherit" onClick = {cancelClick}>Cancel</Button> <Button color="inherit"  >Confirm Delete</Button></div>
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(DeleteQuiz));
