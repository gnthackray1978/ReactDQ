...
import {Node} from "./MiscTypes.js";
import {Point} from "./MiscTypes.js";
import {Spring} from "./MiscTypes.js";
...
export function FDLayout(ctx, channel,graph, camera, settings, parentNode, parentLayout, firstNode) {
    ...
    this.nearestPointDistance = settings.nearestPointDistance;
    this.attractToCentreRepulsion = settings.attractToCentreRepulsion;
...
FDLayout.prototype = {
        ...
        this.eachNode(function (n1, point1) {
            this.eachNode(function (n2, point2) {
              ...
              //      console.log(n1);
                    ...
                    // if(n1.data.type =='score' && n2.data.type =='score'){
                    //   point1.applyForce(direction.multiply(0.01).divide(distance * distance * 0.5));
                    //   point2.applyForce(direction.multiply(0.01).divide(distance * distance * -0.5));
                    // }
                    // else{
    ...
    attractToCentre: function () {
        this.eachNode(function (node, point) {
            ...
            point.applyForce(direction.multiply(this.attractToCentreRepulsion/ 50.0));
        });
    },
    ...
    resetDragListNodeMass:function(e) {
        ...
        console.log('resetDragListNodeMass');
    ...
    handlermouseUp: function (e) {
        ...
        //console.log('mouseUp_'+e.currentTarget.localName );
    ...
    //    console.log('mouseMove: ' + this.selected.node.id + ' ' + this.dragged.node.id);
      ...
      //         };
        ...
        if (this.dragged.node.id !== -1) {
            console.log('dragged position updated: ' + this.dragged.point.p.x + ' ' + p.x);
